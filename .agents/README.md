...
This repo has no command/skill entry points of its own (the `/create-source-image`
command lives in the `loadsmith-lab` repo). When one is added here, put its real,
